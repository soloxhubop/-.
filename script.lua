...
local Theme = {
    Background      = Color3.fromRGB(8, 5, 10),
    Surface         = Color3.fromRGB(20, 10, 20),
    SurfaceHighlight= Color3.fromRGB(50, 20, 40),
    Accent1         = Color3.fromRGB(255, 182, 193),
    Accent2         = Color3.fromRGB(219, 112, 147),
    TextPrimary     = Color3.fromRGB(240, 240, 240),
    TextSecondary   = Color3.fromRGB(140, 140, 150),
    Success         = Color3.fromRGB(255, 182, 193),
...
CreateToggleSwitch(rShowUnlockHUD, Config.ShowUnlockButtonsHUD, function(ns, set)
    ...
    local hudGui = PlayerGui:FindFirstChild("MelStatusHUD")
    if hudGui then
...
CreateToggleSwitch(rJoinerRow, Config.ShowJobJoiner, function(ns, set)
    ...
    local gui = PlayerGui:FindFirstChild("MelJobJoiner")
...
if not IS_MOBILE then
    UserInputService.InputBegan:Connect(function(input, gp)
        ...
        if Config.JobJoinerKey and input.KeyCode == Enum.KeyCode[Config.JobJoinerKey] then
            local joinerGui = PlayerGui:FindFirstChild("MelJobJoiner")
            if joinerGui then
...
task.spawn(function()
    ...
    if PlayerGui:FindFirstChild("MelStatusHUD") then PlayerGui.MelStatusHUD:Destroy() end
    ...
    bgGradient.Color = ColorSequence.new{
        ColorSequenceKeypoint.new(0, Color3.fromRGB(10, 5, 12)),
    ...
    if privateBuild then
        title.Text = "Meloska Hub🌸 PRIVATE"
    else
        title.Text = "Meloska Hub🌸"
    end
    title.Font = Enum.Font.GothamBlack
    ...
    if privateBuild then
        ...
        author.Text = "discord.gg/fkdNuQq4e"
    end
